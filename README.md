...
Build a professional resume in minutes. Choose from 3 templates, fill in your details, and export as PDF or HTML. Your data never leaves your browser.
...
src/
  components/
    Builder.tsx           # Main editor + preview layout
